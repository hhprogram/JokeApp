 ...
 * on 2017-05-19 at 23:01:57 UTC 
 * Modify at your own risk.
 */

package com.example.harrison.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJoke extends MyApiRequest<com.example.harrison.myapplication.backend.myApi.model.MyJoke> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.harrison.myapplication.backend.myApi.model.MyJoke.class);
    }
  ...
  /**
   * Create a request for the method "sayBye".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link SayBye#execute()} method to invoke the remote operation.
   *
   * @param name
   * @return the request
   */
  public SayBye sayBye(java.lang.String name) throws java.io.IOException {
    SayBye result = new SayBye(name);
    initialize(result);
    return result;
  }

  public class SayBye extends MyApiRequest<com.example.harrison.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "sayBye/{name}";

    /**
     * Create a request for the method "sayBye".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link SayBye#execute()} method to invoke the remote operation. <p> {@link
     * SayBye#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
     * be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param name
     * @since 1.13
     */
    protected SayBye(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.harrison.myapplication.backend.myApi.model.MyBean.class);
      this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
    }

    @Override
    public SayBye setAlt(java.lang.String alt) {
      return (SayBye) super.setAlt(alt);
    }

    @Override
    public SayBye setFields(java.lang.String fields) {
      return (SayBye) super.setFields(fields);
    }

    @Override
    public SayBye setKey(java.lang.String key) {
      return (SayBye) super.setKey(key);
    }

    @Override
    public SayBye setOauthToken(java.lang.String oauthToken) {
      return (SayBye) super.setOauthToken(oauthToken);
    }

    @Override
    public SayBye setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SayBye) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SayBye setQuotaUser(java.lang.String quotaUser) {
      return (SayBye) super.setQuotaUser(quotaUser);
    }

    @Override
    public SayBye setUserIp(java.lang.String userIp) {
      return (SayBye) super.setUserIp(userIp);
    }
    ...
    public SayBye setName(java.lang.String name) {
      this.name = name;
      return this;
    }

    @Override
    public SayBye set(String parameterName, Object value) {
      return (SayBye) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.harrison.myapplication.backend.myApi.model.MyBean> {
